<div id="super-product-groups">
	...
	<div id="selected-products-popup" class="side-popup">
		...
		<div class="side-popup-footer">
			{* <button type="button" class="custom-button js-close-selected-popup">Close</button> *}
			<button type="button" class="custom-button add-to-cart js-add-confirmed-selection-to-cart">Voir le
				panier</button>
