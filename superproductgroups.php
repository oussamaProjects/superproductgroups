...
class SuperProductGroups extends Module
{
  ...
  private function getProductGroups(int $productId)
  {
    $sql = new \DbQuery();
    $sql->select('pg.id_group, pg.name, pg.image');
    $sql->from('product_group', 'pg');
    $sql->innerJoin('product_group_relationship', 'pgr', 'pg.id_group = pgr.id_group');
  ...
  public function hookDisplayProductAdditionalInfo($params)
  {
    ...
    $groups = $this->getProductGroups($productId);
